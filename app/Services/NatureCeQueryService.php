...
class NatureCeQueryService
{
    ...
    {
        $allDepenses = $this->baseQuery($filters, applyNatureCeFilter: false)
            ->where('type', 'depense')
            ->get();
        ...
        return [
            'totaux' => [
                'natures_ce_count' => $this->buildNatureCeList($allDepenses)->count(),
            ...
            'natures_ce' => $this->buildNatureCeList($allDepenses)->values()->all(),
