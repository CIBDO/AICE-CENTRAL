...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'admin-observabilite-push': RouteRecordInfo<'admin-observabilite-push', '/admin/observabilite-push', Record<never, never>, Record<never, never>>,
    'admin-regions': RouteRecordInfo<'admin-regions', '/admin/regions', Record<never, never>, Record<never, never>>,
    ...
    'auth-first-login': RouteRecordInfo<'auth-first-login', '/auth/first-login', Record<never, never>, Record<never, never>>,
    ...
    'dashboards-central': RouteRecordInfo<'dashboards-central', '/dashboards/central', Record<never, never>, Record<never, never>>,
    ...
    'dashboards-executive': RouteRecordInfo<'dashboards-executive', '/dashboards/executive', Record<never, never>, Record<never, never>>,
    'dashboards-regional': RouteRecordInfo<'dashboards-regional', '/dashboards/regional', Record<never, never>, Record<never, never>>,
    'details-banques': RouteRecordInfo<'details-banques', '/details/banques', Record<never, never>, Record<never, never>>,
    'details-mandats': RouteRecordInfo<'details-mandats', '/details/mandats', Record<never, never>, Record<never, never>>,
    'details-mandats-id': RouteRecordInfo<'details-mandats-id', '/details/mandats/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'details-natures-ce': RouteRecordInfo<'details-natures-ce', '/details/natures-ce', Record<never, never>, Record<never, never>>,
    'details-programmes': RouteRecordInfo<'details-programmes', '/details/programmes', Record<never, never>, Record<never, never>>,
    'details-recettes': RouteRecordInfo<'details-recettes', '/details/recettes', Record<never, never>, Record<never, never>>,
